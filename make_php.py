...
for irecord, rec in enumerate(records[::-1]):
    ...
    if  Ntotal - irecord == Nmake_email:
        ...
        with open('email2group.txt', 'w') as email_file:
            email_file.write("<section>Dear All,</section>\n")
            email_file.write('<section><h2></h2></section>\n')
            email_file.write("<section>Here is your friendly reminder of our upcoming astro colloquium.</section>\n")
            email_file.write('<section><h2></h2></section>\n')
            email_file.write('<section>Time: %s %s %s @ %s</section>\n'%(currdic['dayshouldgohere'], currdic['dateshouldgohere'], currdic['yearshouldgohere'], currdic['timeshouldgohere']))
            email_file.write('<section>Venue: %s, <a href="https://unimelb.zoom.us/j/88123723593?pwd=cXBaRGp5V3kwd1kzekFTeGRPQzlCQT09">Zoom link</a> (password: 192)</section>\n'%(currdic['locationshouldgohere']))
            ...
            email_file.write('<section><h2></h2></section>\n')
            email_file.write('<small>See more about this talk on <a href="https://qyx268.github.io/astro_colloquium/talks/%s.html">this page</a> or our tentative schedule for future colloquia on <a href="https://qyx268.github.io/astro_colloquium/upcoming.html">this page</a></small>\n'%speakername)
            email_file.write('<section><h2></h2></section>\n')
            email_file.write("<section>Looking forward to seeing you at the talk.</section>\n")
            email_file.write('<section><h2></h2></section>\n')
            email_file.write('<section><h2></h2></section>\n')
            email_file.write("<section>Kind regards,</section>\n")
            email_file.write("<section>Yuxiang</section>\n")

        print('mutt -e "set content_type=text/html" -s "Astro Colloquium (%s, %s, %s, %s)" "astro@physics.unimelb.edu.au" < email2group.txt'%(currdic['dayshouldgohere'],currdic['dateshouldgohere'], currdic['timeshouldgohere'], currdic['locationshouldgohere']))
